        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
              <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Successfull Application</h1>
            </td>
          </tr>
        </table>
        <!--[if (gte mso 9)|(IE)]>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                ...
                <p style="margin: 0;">I am writing to confirm that we have received your application for the {{ $data['attachee']->role->role }} position in our organisation. 
                  We appreciate your interest in our organization and the time you took to submit your application.</p>
              <p>We are currently reviewing all applications and will be in touch with you within two weeks to let you know whether you have been selected for an interview.
                 Please note that due to the large number of applications we receive, we may not be able to respond to every applicant personally.</p>
              <p>If you don't hear back from us within the given time frame, please assume that your application has not been successful on this occasion. However, we encourage you to keep an eye on our website and other job portals for future internship opportunities with us.</p>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">You received this email because we received a request for application  for your account. If you didn't request this you can safely delete this email.</p>
            </td>
          </tr>
          <!-- end permission -->
