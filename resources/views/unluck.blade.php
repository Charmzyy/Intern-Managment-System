            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                  <h1 style="margin: 0; font-size: 20px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Unsuccessfull Interview Reviiew</h1>
                </td>
              </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <p>Dear {{$data['attachee'] }}</p>
                    <p style="margin: 0;">Thank you for applying for the {{ $data['role'] }} Internship in our organisation.
                      We appreciate your interest in our organization and the time you took to submit your application.</p>
                  <p>After careful consideration, through you interview we conducted we regret to inform you that you have not been selected for this position.
                    </p>
                  <p>We recognize the effort you put into your application and want to provide you with some feedback on areas where you can improve for future job applications. Unfortunately, we were unable to select you for the position due to this reason {{$data['reason']}}. We encourage you to work on developing more skills and gaining more experience
