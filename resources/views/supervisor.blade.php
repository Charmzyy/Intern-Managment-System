...
.ExternalClass div {
  ...
  <body style="background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
    <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">You have Been Assigned A Supervisor</span>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        ...
                        <p> Your Work Will mainly involve around the following your main role is  {{ $data['role'] }}  a brief outline of activities will be as follows:
                        {{ $data['description'] }}</p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                            
                            Attached to this email, you will find the rules and regulations that you are required to follow during your internship. These rules and regulations have been designed to ensure that you have a successful and productive internship experience. Please review them carefully and let us know if you have any questions or concerns.
    
                            Please be aware that failure to comply with these rules and regulations may result in termination of your internship.
                            
                            If you have any questions or concerns regarding your supervisor or the rules and regulations, please do not hesitate to contact us.
                            
                          
                            We hope that you will be a valuable asset to our team and contribute to the overall success of the department. We look forward to seeing you.
