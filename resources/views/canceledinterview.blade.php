                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Dear {{ $data['attachee']->fullname }}</p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"> We are sorry to let you know your 
                            meeting {{ $data['interview']->name }} scheduled for {{ $data['interview']->interview_date }} at {{ $data['interview']->interview_time }}
                            has unfortunately been cancleed we will
                              get back to you soon </p>
                     
                        <ul>
                          <li>Warm Regards</li>
                          <li> Admin</li>
                          <li><a href="">admin@email.com</a></li>
                        </ul>
